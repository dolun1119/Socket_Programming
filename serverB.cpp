...
//UDP serverB static port number
...
//get serverB UDP port no.
    ...
    //packet size
    //printf("ServerB listener: packet is %d bytes long\n", numbytes);
...
//read neighbor info 
    cout << "The Server B has the following neighbor information:" << endl;
...
//send TCP    
    ...
    cout << endl <<"The Server B finishes sending its neighbor information to the Client with TCP port number ";
    cout << TCP_PORT;
    cout << " and IP address ";
    cout << cliIP << endl << endl;
    cout << "For this connection with the Client, the Server B has TCP port number ";
    ...
    //run UDP
    udpListener (SB_UDP_PORT);
    cout << "\nThe server B has received the network topology from the Client with UDP port number ";
    cout << portn;
    cout << " and IP address ";
    cout << udpCip;
...
//print out topology from client
    ...
    cout << endl << "For this connection with Client, The Server B has UDP port number ";
    cout << SB_UDP_PORT;
    cout << " and IP address ";
