...
//UDP serverD static port number
...
//get serverD UDP port no.
    ...
    //packet size
    //printf("ServerD listener: packet is %d bytes long\n", numbytes);
...
//send TCP    
    ...
    cout << endl <<"The Server D finishes sending its neighbor information to the Client with TCP port number ";
    cout << TCP_PORT;
    cout << " and IP address ";
    cout << cliIP << endl << endl;
    cout << "For this connection with the Client, the Server D has TCP port number ";
...
//run UDP
    udpListener (SD_UDP_PORT);
    cout << "\nThe server D has received the network topology from the Client with UDP port number ";
    cout << portn;
    cout << " and IP address ";
    cout << udpCip;
...
//print out topology from client
    ...
    cout << endl << "For this connection with Client, The Server D has UDP port number ";
    cout << SD_UDP_PORT;
    cout << " and IP address ";
