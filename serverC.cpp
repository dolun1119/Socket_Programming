...
#define TCP_PORT "25327"  // the port users will be connecting to
...
//get serverA UDP port no.
    ...
    //packet size
    //printf("ServerC listener: packet is %d bytes long\n", numbytes);
...
//read neighbor info 
    cout << "The Server C has the following neighbor information:" << endl;
...
//send TCP    
    ...
    cout << endl <<"The Server C finishes sending its neighbor information to the Client with TCP port number ";
    cout << TCP_PORT;
    cout << " and IP address ";
    cout << cliIP << endl << endl;
    cout << "For this connection with the Client, the Server C has TCP port number ";
...
//print out topology from client
    ...
    cout << endl << "For this connection with Client, The Server C has UDP port number ";
    cout << SC_UDP_PORT;
    cout << " and IP address ";
